...
class _LibraryScreenState extends State<LibraryScreen> {
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: Container(
                ...
                child: Center(child: Icon(Icons.local_library_rounded, color: Colors.white.withOpacity(0.12), size: 120)),
              ),
            ),
          ),
          SliverToBoxAdapter(
                    ...
                    child: GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: isSelected ? const Color(0xFF3B82F6) : (isDark ? Colors.white.withOpacity(0.05) : const Color(0xFFE8EDF5))),
                        ),
  ...
  Future<void> _toggleAvailability(LibraryBook book) async {
    final updated = book.copyWith(isAvailable: !book.isAvailable, dueDate: !book.isAvailable ? null : DateTime.now().add(const Duration(days: 14)).toIso8601String().split('T')[0]);
...
class _BookCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Container(width: 52, height: 52, decoration: BoxDecoration(color: const Color(0xFF3B82F6).withOpacity(0.1), borderRadius: BorderRadius.circular(14)), child: const Icon(Icons.book_rounded, color: Color(0xFF3B82F6), size: 24)),
            ...
            child: Column(
              ...
              children: [
                ...
                if (!book.isAvailable && book.dueDate != null) ...[
                  ...
                  Text('Due: ${book.dueDate}', style: const TextStyle(color: Color(0xFFEF4444), fontSize: 11, fontWeight: FontWeight.w600)),
                ],
              ],
            ),
          ),
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: book.isAvailable ? const Color(0xFFEF4444).withOpacity(0.08) : const Color(0xFF10B981).withOpacity(0.08),
